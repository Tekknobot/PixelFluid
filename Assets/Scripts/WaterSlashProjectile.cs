...
namespace PixelOcean
{
    ...
    public sealed class WaterSlashProjectile : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D other)
        {
            ...
            else if (other.GetComponentInParent<DayFiveCombatant>() is { CanBeHit: true } security)
            {
            ...
            else if (other.GetComponentInParent<DaySixSkyHostile>() is { CanBeHit: true } daySixSkyHostile)
            {
