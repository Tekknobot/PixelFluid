...
namespace PixelOcean
{
    ...
    public sealed class BloodSharkLaneSwimmer : MonoBehaviour
    {
        private enum PredatorState { Patrol, Stalk, Attack, Search, Retreat }

        [Header("Swimming")]
        [SerializeField, Min(0.05f)] private float horizontalSpeed = 1.05f;
        [SerializeField] private bool startMovingRight = true;
        [SerializeField, Range(0f, 0.35f)] private float viewportPadding = 0.045f;

        [Header("Predator Awareness")]
        [SerializeField, Min(0.5f)] private float detectionRange = 2.4f;
        ...
        [SerializeField, Min(0f)] private float attackRecovery = 1.25f;
        ...
        [Header("Hit Retreat")]
        [SerializeField, Min(0.1f)] private float hitRetreatDuration = 1.15f;
        ...
        private DayTwoPredatorAnimation sharkAnimation;
        ...
        public void Initialise(int requestedLane, bool spawnAtSectionEdge = false)
        {
            ...
            {
                Debug.LogError("BloodSharkLaneSwimmer requires at least two water layers.", this);
                enabled = false;
                return;
            }
        ...
        private void ResolveReferences()
        {
            ...
            sharkAnimation = GetComponent<DayTwoPredatorAnimation>();
